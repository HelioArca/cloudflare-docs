...
## Workers and Transform Rules cannot influence caching

Cache Response Rules are the only rule type that can modify caching behavior based on origin response headers. Workers and Response Header Transform Rules execute after the caching decision has been made and cannot influence whether or how a response is cached.
