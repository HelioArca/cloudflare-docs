...
- [Create an API token](/fundamentals/api/get-started/create-token/) (refer to the [minimum required permissions](/cloudflare-one/networks/connectors/cloudflare-tunnel/deployment-guides/terraform/#3-create-a-cloudflare-api-token))
...
Your Access application and policy are under **Zero Trust** > **Access controls** > **[Applications](https://one.dash.cloudflare.com/?to=/:account/access/apps)**.
