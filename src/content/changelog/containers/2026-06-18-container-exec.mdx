---
title: Run processes programmatically inside Durable Object Containers
...
The Durable Object Container API now provides `this.ctx.container.exec()` for starting processes inside a running [Container](/containers/). You can stream standard input and output, inspect exit codes, and signal each process.
